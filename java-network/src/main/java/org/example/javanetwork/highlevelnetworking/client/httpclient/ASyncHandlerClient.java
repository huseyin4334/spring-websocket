package org.example.javanetwork.highlevelnetworking.client.httpclient;
...
public class ASyncHandlerClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // thenApply() returns a new CompletionFeature<Stream<?>> object.
            // thenAccept() is a terminal operation that returns a CompletionFeature<Void> object.
            // This means that the terminal operation is the last operation in the chain.
            // thenRun() is a terminal operation that returns a CompletionFeature<Void> object. It does not take a parameter. Only executes a Runnable.
